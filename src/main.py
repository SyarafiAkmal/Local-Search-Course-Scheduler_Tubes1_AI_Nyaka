...
if __name__ == "__main__":
    ...
    match algorithm:
        ...
        case "experiment":
            ...
            print("\nEksperimen variasi 1, n_generasi: 100, populasi: 30")
            start_time = time.time()
            genetic_1 = GeneticAlgorithm(input=input_file, population_size=30)
            ...
            print("\nEksperimen variasi 2, n_generasi: 100, populasi: 70")
            start_time = time.time()
            genetic_2 = GeneticAlgorithm(input=input_file, population_size=70)
            ...
            print("\nEksperimen variasi 3, n_generasi: 100, populasi: 120")
            start_time = time.time()
            genetic_3 = GeneticAlgorithm(input=input_file, population_size=120)
            ...
            print("\nEksperimen variasi 4, n_generasi: 30, populasi: 100")
            start_time = time.time()
            genetic_1 = GeneticAlgorithm(input=input_file)
            genetic_1.run(name="GA_variasi4")
            end_time = time.time()
            genetic_1.plot(name="GA4_plot")
            print(f"Durasi variasi Genetic Algorithm 1: {end_time - start_time}s")

            print("\nEksperimen variasi 5, n_generasi: 70, populasi: 100")
            start_time = time.time()
            genetic_2 = GeneticAlgorithm(input=input_file)
            genetic_2.run(name="GA_variasi5")
            end_time = time.time()
            genetic_1.plot(name="GA5_plot")
            print(f"Durasi variasi Genetic Algorithm 2: {end_time - start_time}s")

            print("\nEksperimen variasi 6, n_generasi: 120, populasi: 100")
            start_time = time.time()
            genetic_3 = GeneticAlgorithm(input=input_file)
